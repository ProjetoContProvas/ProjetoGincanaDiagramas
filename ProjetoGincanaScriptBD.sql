create database projetogincana;
...
insert into tb_gincana (nome_Gincana, descricao_Gincana, data_inicio_Gincana, data_fim_Gincana, id_Status) 
	values ("gincana2023", "gincana cientifica do cetep", "2022-10-02", "2022-10-05", 1);
...
insert into tb_galeria (nome_Galeria, descricao_Galeria, id_Gincana) values ("Galeria de info", "descricao de teste da galeria",1),
																			("Galeria de eletro", "descricao de teste da galeria",1);  


insert into tb_imagem(URL_Imagem, id_galeria) values ("https://img.freepik.com/fotos-gratis/amor-romance-perfurado-coracao-de-papel_53876-87.jpg?w=2000", 1),
                                                     ("https://img.freepik.com/fotos-gratis/amor-romance-perfurado-coracao-de-papel_53876-87.jpg?w=2000", 1),
													 ("https://img.freepik.com/fotos-gratis/amor-romance-perfurado-coracao-de-papel_53876-87.jpg?w=2000", 2); 

insert into tb_perfil (cargo_perfil) values ("Administrador"),
                                            ("Representante"),
											("Organizador"),
                                            ("Jurado");  
                                            
                                            
insert into tb_usuario (nome_Usuario, email_Usuario, senha_Usuario, sexo_Usuario, data_cadastro_Usuario, id_Gincana, id_Perfil) values ("Rhuan", "Ruan@gmail.com","123456", "Masculino", "2022-10-23", 1,1 );



insert into tb_usuario_evento (id_Usuario, id_Evento) values (1,1);


insert into tb_curso(nome_Curso, modalidade_Curso) values ("Informática", "Integrado"),
                                                          ("eletromecânica", "Integrado"),
                                                          ("biocombustíveis", "Integrado");

insert into tb_equipe(nome_Equipe, descricao_Equipe, id_Gincana, id_Curso, id_Usuario) values ("hardtec","equipe 1",1,1,1);




insert tb_criterio(nome_Criterio, pontuacao_min_Criterio, pontuacao_max_Criterio, id_Evento) values ("Apresentação", 0, 10, 2);


insert into tb_notas_criterio(nota_Criterios, id_Criterio, id_equipe) values (10, 1, 1)
